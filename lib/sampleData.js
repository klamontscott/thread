  ...
  themes: [
    {
      ...
      confidence: "high",
      mentionCount: 7,
      relatedKeywords: ["setup", "configuration", "too many steps", "getting started", "overwhelming", "wizard"],
      supportingQuotes: [
        {
    ...
    },
    {
      ...
      confidence: "high",
      mentionCount: 5,
      relatedKeywords: ["black box", "reasoning", "why", "trust", "explained"],
      supportingQuotes: [
        {
    ...
    },
    {
      ...
      confidence: "medium",
      mentionCount: 3,
      relatedKeywords: ["didn't know", "hidden", "never noticed", "buried"],
      supportingQuotes: [
        {
    ...
    },
    {
      ...
      confidence: "medium",
      mentionCount: 4,
      relatedKeywords: ["sharing", "Slack", "screenshot", "team", "workaround"],
      supportingQuotes: [
        {
