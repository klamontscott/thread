...
- Use exact quotes from the transcript as evidence — include 2-4 quotes per theme
- mentionCount: count every distinct moment in the transcript where this theme is referenced or alluded to, not just direct quotes
- relatedKeywords: 3-6 actual words or short phrases from the transcript that cluster around this theme (e.g. "setup friction", "too many steps", "overwhelming")
